...
public class TaPManagerImpl implements TaPManager {
	...
	public ReceiptData getReceipt(int id) {
		...
		if(id==0){
			...
			ArrayList<ProductData> myProducts = new ArrayList<ProductData>();
			myProducts.add(new ProductData(152, 15, 16, "Grouda geschnitten", "logo.png", 20, 80, 325, "€", "260", new Unit(23, "g"),true));
			myProducts.add(new ProductData(120, 15, 16, "Ja!Natürlich Milch 1L", "logo.png", 50, 30, 98, "€", "1", new Unit(24, "l"),false));
			myProducts.add(new ProductData(12, 15, 16, "Coca Cola 2L", "logo.png", 50, 100, 230, "€", "2", new Unit(25, "l"),true));
	...
	public ProductData getProduct(int id) {
		// TODO Auto-generated method stub
		return new ProductData(152, 15, 16, "Grouda geschnitten", "logo.png", 20, 80, 325, "€", "260", new Unit(23, "g"),true);
	}
	...
	public void search(String userInput, SearchWidget sw) {
		...
		ArrayList<Entity> tmp= new ArrayList<Entity>();
			...
			tmp.add(new ProductData(13, 15, 16, "Gouda Kaese", "logo.png", 50, 50, 1200, "€", "250", new Unit(23, "g")));
