...
public class ProductServiceImpl extends RemoteServiceServlet implements IProductService {
	...
	public ProductServiceImpl() {
		...
		try {
			coreService = (org.tagaprice.core.api.IProductService) Boot.getApplicationContext().getBean(
			"defaultProductService");
			// TODO/WORKAROUND this should be mapped by spring, but does not work yet


			// ((DefaultProductService) coreService).setProductDAO((IProductDAO)
			// Boot.getApplicationContext().getBean("defaultProductDAO"));
			// ((DefaultProductService) coreService).setProductRevisionDAO((IProductRevisionDAO)
			// Boot.getApplicationContext().getBean("defaultProductRevisionDAO")); //TODO/WORKAROUND this should be
			// mapped by spring, but does not work yet
	...
	public IProduct getProduct(IRevisionId revionsId) {
		...
		ArrayList<IProduct> list = getProducts(new org.tagaprice.client.gwt.shared.entities.productmanagement.Product(
				"a", null, null));
