...
abstract class PropertyHandler extends Composite implements IPropertyHandler {
	...
	protected HashMap<String, ArrayList<Property>> hashProperties;
	protected PropertyGroup propGroup;
	PropertyChangeHandler handler;
	
	public PropertyHandler(HashMap<String, ArrayList<Property>> hashProperties, PropertyGroup propGroup, PropertyChangeHandler handler) {
