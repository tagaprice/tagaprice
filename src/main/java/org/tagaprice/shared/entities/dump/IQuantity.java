...
public interface IQuantity extends Serializable {
	...
	/**
	 * Sets the {@link org.tagaprice.shared.entities.productmanagement.IProduct} size.
	 * 
	 * @param quantity
	 *            Sets the {@link org.tagaprice.shared.entities.productmanagement.IProduct} size.
	 */
	...
	/**
	 * Returns the size in which a {@link org.tagaprice.shared.entities.productmanagement.IProduct} can be
	 * bought
	 * 
	 * @return the size in which a {@link org.tagaprice.shared.entities.productmanagement.IProduct} can be
	 *         bought
	 */
