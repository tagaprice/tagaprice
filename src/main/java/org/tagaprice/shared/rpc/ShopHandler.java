...
public interface ShopHandler extends RemoteService {
	Shop get(long id) throws IllegalArgumentException, ServerException;
	Shop save(Shop data)  throws IllegalArgumentException, InvalidLoginException, DAOException, ServerException;
