...
public class MockDaoFactory implements IDaoFactory {
	...
	public MockDaoFactory() throws DaoException {
		...
		Package bergkasese1=m_packageDAO.create(new Package(new Quantity(new BigDecimal("500.335"), g)));
		...
		Package bergkasese2=m_packageDAO.create(new Package(new Quantity(new BigDecimal("500.510"), g)));
		...
		Package limonPack1=m_packageDAO.create(new Package(new Quantity(new BigDecimal("200.323"), g)));
		...
		is2.setAddress(new Address("Blumauergasse 1B", 48.1804, 16.3937));
		//is2.setParent(s1);
		...
		is3.setAddress(new Address("Holzhausergasse 9", 48.2322,  16.3592
));
		//is3.setParent(s1);
...

		{
			...
			//Receipt Entry
			ReceiptEntry recEnt = new ReceiptEntry(new Price(new BigDecimal("15.015"), Currency.euro), bergkasese1);
...

		{
			...
			//Receipt Entry
			ReceiptEntry recEnt = new ReceiptEntry(new Price(new BigDecimal("20.023"), Currency.euro), bergkasese2);
			receipt.addReceiptEntries(recEnt);
			receipt=m_receiptDAO.create(receipt);
		}
		
		{
			...
			//Receipt Entry
			receipt.addReceiptEntries(new ReceiptEntry(new Price(new BigDecimal("16.154"), Currency.euro), bergkasese1));
			receipt.addReceiptEntries(new ReceiptEntry(new Price(new BigDecimal("17.301"), Currency.euro), limonPack1));
			receipt=m_receiptDAO.create(receipt);
		}

		{
			...
			//Receipt Entry
			receipt.addReceiptEntries(new ReceiptEntry(new Price(new BigDecimal("13.022"), Currency.euro), limonPack1));
			receipt.addReceiptEntries(new ReceiptEntry(new Price(new BigDecimal("14.034"), Currency.euro), bergkasese2));
			receipt=m_receiptDAO.create(receipt);
		}
