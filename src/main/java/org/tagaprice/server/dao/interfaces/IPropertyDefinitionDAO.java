...
public interface IPropertyDefinitionDAO {
	 ...
	 * @throws DAOException
	 */
	PropertyTypeDefinition getById(long id) throws DAOException;
	 ...
	 * @throws DAOException
	 */
	PropertyTypeDefinition getByIdAndRef(long id, int revision) throws DAOException;
	 ...
	 * @throws DAOException
	 */
	PropertyTypeDefinition getByNameAndLocalId(String name, int localeId) throws DAOException;
}
