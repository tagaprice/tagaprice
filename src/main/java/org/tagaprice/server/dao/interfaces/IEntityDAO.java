...
public interface IEntityDAO {
	...
	/**
	 * Saves given entity to storage. If the entity does not exist, a new entity will be created, otherwise a new revision of the entity will be created. Given entity will not be changed.
