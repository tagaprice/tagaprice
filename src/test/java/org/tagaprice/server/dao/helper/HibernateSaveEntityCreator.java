...
public class HibernateSaveEntityCreator {
	...
	public static ReceiptEntry createReceiptEntry(BasicReceipt basicReceipt, ProductRevision rev, Integer count, Integer pricePerItem) {
		return new ReceiptEntry(basicReceipt, rev, count, pricePerItem);
	}

	public static BasicReceipt createBasicReceipt(long receiptId, BasicShop basicShop) {
		return new BasicReceipt(receiptId, basicShop);
	}
}
